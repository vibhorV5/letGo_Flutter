...
class DetailsPageSuggested extends StatefulWidget {
  final SuggestedSessions suggestedSessions;

  DetailsPageSuggested(this.suggestedSessions);

  @override
  State<DetailsPageSuggested> createState() => _DetailsPageSuggestedState();
}

class _DetailsPageSuggestedState extends State<DetailsPageSuggested> {
  var checkPlay = 0;
  ...
  void initState() {
    ...
    myAudioPlayer!.setUrl(widget.suggestedSessions.details['audio']!);
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Stack(
            children: [
              Image.asset(widget.suggestedSessions.details['imgUrl']!),
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        widget.suggestedSessions.details['genre']!,
                    ...
                    FittedBox(
                      child: Container(
                          ...
                          child: Text(
                            widget.suggestedSessions.details['title']!,
                        ...
                        GestureDetector(
                          onTap: () {
                            if (isPlaying == false) {
                              setState(() {
                                myAudioPlayer!.play(
                                    widget.suggestedSessions.details['audio']!);
                                isPlaying = true;
                                checkPlay = 1;
                              });
          ...
          Container(
            ...
            height: 185,
            child: Text(
              widget.suggestedSessions.details['desc']!,
              style: TextStyle(
                letterSpacing: 0.3,
                fontSize: 17,
                color: kTexts,
  ...
  Widget loadButton() {
    ...
    return IconButton(
      onPressed: () async {
        if (isPlaying == false) {
          await myAudioPlayer!.play(widget.suggestedSessions.details['audio']!);
          setState(() {
            isPlaying = true;
          });
        } else if (isPlaying == true) {
  ...
  Widget durationDisplay() {
    if (isPlaying == false && checkPlay == 0) {
      return Text(
        widget.suggestedSessions.details['duration']!,
